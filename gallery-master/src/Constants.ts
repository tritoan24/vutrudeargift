...
export const BOARDS_INFO: Record<string, {
    ...
    1: {
		...
		`,
        img: "https://res.cloudinary.com/dtcyfyauk/image/upload/v1750091709/x0af91kvihtfyv4qcyis.jpg",
        type: "info"
    },
    2: {
    ...
    8: {
		...
		`,
        img: "https://res.cloudinary.com/dtcyfyauk/image/upload/v1750084596/kp2mlcmsl1izmgekza6p.jpg",
        type: "info"
    },
    9: {
    ...
    10: {
        ...
        `,
        img: "https://res.cloudinary.com/dtcyfyauk/image/upload/v1750108775/jyzvvfj3b3se2nuyzenr.jpg",
        type: "question",
    ...
    big: { // Board lớn
        title: "《Bức Tranh Chủ Đề》",
        author: "Thjnh",
        describe: `
        Đây là bức tranh lớn nhất, đại diện cho chủ đề của triển lãm.<br>
        Hãy cảm nhận thông điệp và vẻ đẹp mà nó mang lại!
        `,
        img: "https://res.cloudinary.com/dtcyfyauk/image/upload/v1750149258/tlz0fvvzqx3z0gvotyji.jpg", // Đổi link ảnh lớn tại đây
        type: "info"
    }
};
