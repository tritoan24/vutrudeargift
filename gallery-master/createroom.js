...
document.getElementById('roomForm').addEventListener('submit', async (e) => {
 ...
 // --- BẮT ĐẦU: Thanh toán trước ---
  try {
    ...
    const res = await fetch('https://1272-2405-4802-1d77-87c0-d41-8c15-b0fe-b90d.ngrok-free.app/api/payment/create', {
      method: 'POST',
...
console.log(">> Link thanh toán:", resultData.data && resultData.data.checkoutUrl);
  ...
  try {
    const res = await fetch('https://1272-2405-4802-1d77-87c0-d41-8c15-b0fe-b90d.ngrok-free.app/api/boards', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
